...
<div class="bg">
	...
	<div id="stylized" class="myform">
	    <form method="POST" action="${act}" name="frmAddParticipan" enctype="multipart/form-data">
	        ...
	        <label>Name*</label> 
	        <input type="text" name="fname" value="${record.fname}" placeholder="Name" readonly/> <br><br><br>
	        <label>Surname*</label>
	        <input type="text" name="lname" value="${record.lname}" placeholder="surname" readonly/> <br><br><br>
	        <label>Email*</label>
